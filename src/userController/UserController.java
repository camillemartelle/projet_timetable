...
public class UserController implements IUserController
{
	...
	/**
	 * Contient une instance de base de donnÃƒÂ©es d'utilisateurs
	 * 
	 */
	...
	/**
	 * Constructeur de controleur d'utilisateurs crÃƒÂ©ant la base de donnÃƒÂ©es d'utilisateurs
	 * 
	 * @param userfile
	 * 		Fichier XML contenant la base de donnÃƒÂ©es d'utilisateurs
	 */
	...
	public String getUserName(String userLogin) {
		...
		//On evite de parcourir toute la liste d'Ã©tudiants pour trouver un prof ou un admin
	...
	public int getStudentGroup(String studentLogin) {
		...
		int i = 0;
		//on recherche l'étudiant via son login
		while(i < listStudent.size()){
	...
	public boolean removeUser(String adminLogin, String userLogin) {
		...
		//on parcourt la liste d'étudiant, s'il existe on le supprime du groupe avant de le supprimer
		if(isStudent(userLogin)){
			...
			while(i<listStudent.size()){
				...
				if(userLogin.equals(listStudent.get(i).getLogin())){
					...
					int j =0;
					//le numero de groupe ne correspond pas Ã  son index dans la liste
	...
	public boolean removeGroup(String adminLogin, int groupId) {
		...
		int i =0, j=0;
		//on recupère les etudiants du groupe en question
		while(i<listGroupe.size()){
			if(listGroupe.get(i).getId_groupe()==groupId)
		...
		i=0;
		//on met le statut des étudiants à "sans groupe" via la valeur -1
	...
	public String[] usersLoginToString() {
		...
		//on recupÃ¨re les logins des Ã©tudiants
		...
		//On recupÃ¨re le nombre d'Ã©lÃ©ments du tableau pour avoir l'index Ã  utiliser
		int j=0, k = 0;
		for(Object o : userLogins)
			if(o != null) j++;
		
		
		//On rÃ©cupÃ¨re les logins des profs et admins qu'on rajoute Ã  ceux presents dans le tableau
	...
	public boolean loadDB() {
	      ...
	      try
	      {
	        ...
	        //on lit le document pour le charger en mémoire vive sous forme d'objets
	...
	public boolean saveDB() {
			...
			//on recrée l'architecture du document pour le réécrire
